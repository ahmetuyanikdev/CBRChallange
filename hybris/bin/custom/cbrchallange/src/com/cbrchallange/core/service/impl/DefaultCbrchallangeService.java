...
public class DefaultCbrchallangeService implements CbrchallangeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCbrchallangeService.class);
	...
	{
		return DefaultCbrchallangeService.class.getResourceAsStream("/cbrchallange/sap-hybris-platform.png");
	}
